...
const IMAGE_SWAPS: Record<Locale, Array<{ from: string; to: string }>> = {
  en: [
    ...
    { from: "/media/files/land/280/21b80358547be97456baf00ac6a98ac9.jpeg", to: NEW_HERO_IMAGE },
    ...
    { from: "/media/files/land/278/a922320ee5958be2e94a1a5ee8f71862.jpeg", to: NEW_HERO_IMAGE },
  ...
  ru: [
    ...
    { from: "/media/files/land/281/a28f89e68424d07c9051aefed1260d8f.jpeg", to: NEW_HERO_IMAGE },
